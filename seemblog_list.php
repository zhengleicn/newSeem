...
$link = connect();
$member_state = is_login($link);//有page和type两个get参数，目前做了非数字转化为1处理
?>
...
<div class="main_container">
    ...
    <div class="left_main">
        <div style="width: 90%;">
            <h3 style="float: left">&nbsp;&nbsp;&nbsp;最新文章 </h3>
            <div id="page_button">
                <?php
                if (!isset($_GET['type']) || $_GET['type'] == 0|| !is_numeric($_GET['type'])) {
...
A;
        ...
        if (!isset($_GET['type']) || $_GET['type'] == 0) {
            $query = "select * from artical order by edit_time desc limit {$limit_start},7";
        } else {
            $query = "select * from artical where type='{$_GET['type']}' order by edit_time desc limit {$limit_start},7";
        }
        //文章分类
...
<div id="artical1">
    <article style="padding-bottom: 0px;">
        ...
        <div style="clear:none;width:15%;position: relative;float: left;"><p style="font-size: small;"><embed src="./icon/writer.svg" width="15" height="15" style="position:relative; top:2px;"
"
type="image/svg+xml"
pluginspage="http://www.adobe.com/svg/viewer/install/" />
        
        <a href="member.php?people={$datarow['uid']}" style="text-decoration:none;color:darkgreen;font-weight: 600;"> {$datarow['name']}</a></p></div>
        <div style="clear: none;width: 70%;position: relative;float: left;"><p style="font-size: small;">&nbsp;&nbsp;&nbsp;&nbsp;
...
pluginspage="http://www.adobe.com/svg/viewer/install/" />
        ...
        <embed src="./icon/comment.svg" width="15" height="15" style="position:relative; top:2px;"
"
type="image/svg+xml"
pluginspage="http://www.adobe.com/svg/viewer/install/" />
...
{$datarow['watch']}&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p style="padding: 0;"></p></div><div style="clear: both";></div>
    </article>
</div>
A;
            echo $html;
