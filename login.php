        ...
        <div class="right_main">
            ...
            <article>
                <form action="login_check.php"    method="post">
                    ...
                    <label><input  type="text" name="uid" placeholder="uid(不是昵称)" style="border: 1px solid rgb(0, 0, 0); width: 97%;height: 30px;" /></label>
                    <br/><br/>
                    <label><input  type="password" name="pw" placeholder="密码" style="border: 1px solid rgb(0, 0, 0); width: 97%;height: 30px;" /></label>
                    <br/><br/>
                    <button  type="submit" wrap="physical" name="submit" value="登录" style="width: 100% ;color: white;background-color: black;
                             border-radius: 0; border-color: black;height: 45px;font-size:larger; ">登录</button>
